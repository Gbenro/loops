...
const PHASES_META = Object.fromEntries(
  Object.keys(PHASE_LABELS).map((key) => [
    key,
    { label: PHASE_LABELS[key], accent: PHASE_ACCENTS[key] },
  ])
);
...
export function CheckInSheet({
  ...
  const dayContext =
    dayInPhase !== null && phaseDuration !== null
      ...
      >
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          >
            ...
            {dayContext && <span style={{ color: 'var(--color-text-muted)' }}>• {dayContext}</span>}
          </div>
          <div
            style={{
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: isSelected ? `${meta.accent}12` : 'var(--color-input-bg)',
                  cursor: 'pointer',
                  textAlign: 'left',
