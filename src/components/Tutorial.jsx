...
const GUIDE_STEPS = [
  ...
  },
  {
    ...
    fallbackBody:
      "This card appears within 24 hours of the next phase shift. It names what's coming and gives you its invitation — so you can meet the shift consciously.",
  },
  {
  ...
  },
  {
    ...
    fallbackBody:
      'One intention for the full 29.5 days. Set at the New Moon as a ceremony and pinned for the entire arc. Open at the New Moon to set yours.',
  },
  {
    ...
    fallbackBody:
      'Smaller moves aligned to the energy of each phase. 1–2 per waxing phase. As you open loops, they appear here sorted by when they were opened.',
  ...
  },
  {
    ...
    fallbackBody:
      'Nearly invisible when idle, alive when listening. Tap to start, tap to stop. What you speak becomes an echo stamped with the phase and time.',
  },
  {
    ...
    fallbackBody:
      'Each echo carries a lunar stamp — phase name, type (THR/FLW), and moon age in days. The calendar date is hidden by default; lunar context is always primary.',
...
const PHASE_DATA_ORIGINAL = [
  {
    ...
    description:
      'The New Moon is not a phase to move through — it is a threshold to cross. The sky goes dark and something new becomes possible. This is the most important moment in the cycle. Everything that follows grows from what is planted here.',
    body2:
      'You do not plan at the New Moon. You plant. One intention. No subtasks, no categories, no metadata. The cycle loop opens here as a ceremony, held for the full 29.5 days.',
  ...
  },
  {
    ...
    description:
      "First light after darkness. The intention you planted is beginning to move. Take small, deliberate steps. This phase rewards momentum — each action compounds. Trust the direction even if you can't yet see the destination.",
  ...
  },
  {
    ...
    description:
      "Half-lit, half-dark. The tension between intention and reality peaks here. Obstacles test what you're willing to commit to. This is not the place for reassessment — it's the place for decision. Commit fully or let go cleanly.",
  ...
  },
  {
    ...
    description:
      "Almost full. The shape of what you're building is visible. This is not the time to revolutionise — it's the time to refine. Adjust the details. Trust what you've built. The peak is approaching and your work wants to be ready to meet it.",
    loopBehaviour:
      'Refine active loops. Adjust details. Do not open new loops — finish existing ones.',
  ...
  },
  {
    ...
    description:
      "Maximum light. Everything illuminated. What you built is visible in full — including what didn't work. This is the harvest and the revelation simultaneously. Let what is true arrive without editing it. Celebrate completions. See clearly.",
  ...
  },
  {
    ...
    description:
      'The peak has passed. The energy is full but moving downward. This is the natural phase of sharing and teaching — what you learned wants to be given back. Gratitude flows easily here. Begin the releasing process with active loops.',
  ...
  },
  {
    ...
    description:
      "Half-lit again, but releasing now. What didn't complete, didn't work, or isn't serving you — this is the moment to let it go. Not with force, but with clarity. The field needs to be cleared for what's next. Forgiveness is practical here.",
  ...
  },
  {
    ...
    description:
      'The final sliver before darkness. The cycle is completing. Do not begin new things here — let the old cycle finish. Rest is not laziness; it is preparation. The quality of your next New Moon is shaped by how fully you rest now.',
...
const PHASE_DATA_V2 = [
  {
    ...
    description:
      'A quiet darkness surrounds you. Something subtle stirs within — a seed of intention waiting to emerge. There is no need to act yet. Sit with the stillness, notice your inner stirrings, and honor what wants to grow.',
    body2:
      'You do not plan at the New Moon. You plant. One intention. No subtasks, no categories, no metadata. The cycle loop opens here as a ceremony, held for the full 29.5 days.',
    bodyState: 'Still, empty, quietly receptive',
    loopBehaviour: 'Open 1 cycle loop only. No phase loops. No tasks. The what and why only.',
    ...
    activities: [
      ...
      'Rest and allow the seed to form',
    ],
    entrainment: 'You can sit with the void without filling it.',
  },
  {
    ...
    bodyState: 'Energy rising, momentum building',
    description:
      "The moon's first sliver appears. Energy rises. Ideas spark and possibilities abound. Curiosity and excitement guide your exploration. This is a time to gather, imagine, and dream around your intention, without committing to everything that arises.",
    loopBehaviour: 'Open 1–2 phase loops. Focus on first steps and building structure.',
    activities: [
      'Capture ideas and thoughts',
      'Notice what resonates',
      'Explore freely, stay close to your seed',
    ],
    entrainment: 'You begin before you feel ready.',
  },
  {
    ...
    bodyState: 'Tension and decisiveness',
    description:
      'Half light, half dark. The cycle asks for a decision. Some ideas move forward; others return to rest. Focus your energy on the path that will allow your intention to grow. Choosing clarity now gives momentum to the next phases.',
    loopBehaviour: 'Face the obstacle in each active loop. Make one clear decision per loop.',
    activities: [
      'Place ideas in light or dark',
  ...
  },
  {
    ...
    bodyState: 'Refinement, anticipation',
    description:
      'The moon grows almost full. Energy surges. The chosen path now demands creation. Build, shape, and refine your work. Focused action transforms the seed into something tangible. This is a phase of energy, momentum, and dedication.',
    loopBehaviour:
      'Refine active loops. Adjust details. Do not open new loops — finish existing ones.',
    activities: [
      'Develop your chosen idea',
      'Notice what strengthens or weakens',
      'Keep work aligned and intentional',
    ],
    entrainment: 'You refine without starting over.',
  },
  {
    ...
    bodyState: 'Peak energy, heightened emotion',
    description:
      'The moon is fully illuminated. The work of the cycle shines clearly. Celebrate what has grown. Witness your progress, honor your achievements, and share the joy. The Full Moon reveals the tangible outcome of your intentions.',
    loopBehaviour: 'No new loops. See what the light reveals. Close loops that have completed.',
    activities: [
      'Observe what you have built',
  ...
  },
  {
    ...
    bodyState: 'Integration, generosity',
    description:
      'The light begins to wane, flowing outward. This is the phase of giving and connecting. Share your creations and gather feedback. Reflect on lessons and insights, while connecting with others and the energy that comes from sharing your harvest.',
    loopBehaviour: 'Share progress. Close loops that served their purpose. Begin releasing.',
    activities: [
      'Share work or insights',
      'Collect feedback',
      'Connect with people around your work',
    ],
    entrainment: 'You give without needing to keep.',
  },
  {
    ...
    bodyState: 'Release, spaciousness',
    description:
      "Half-dark, half-light. Momentum inward. Energy quiets. This is a phase of reflection, evaluation, and alignment. Observe what worked, release what didn't, and prepare for the next cycle. Minimal action, maximum insight.",
    loopBehaviour: "Release loops that didn't close. Clear incomplete intentions. Forgive.",
    activities: [
      'Review work from this cycle',
  ...
  },
  {
    ...
    bodyState: 'Deep rest, dreamlike',
    description:
      "Darkness deepens. Energy slows. Fully release the cycle's work and rest deeply. Integrate the lessons, honor the journey, and prepare for the next New Moon. This phase is a quiet pause before the next beginning.",
    loopBehaviour: 'Do not open loops. Rest. Let the cycle complete naturally.',
    activities: [
      'Rest physically and mentally',
      'Reflect on lessons and growth',
      'Release fully and prepare',
    ],
    entrainment: 'You rest before you feel the tiredness.',
  },
];
...
export function Tutorial({ onClose, activeTab, onSwitchTab, initialMode = 'guide' }) {
      ...
      if (IS_V2 && step?.action) {
        setTimeout(() => {
          window.dispatchEvent(
            new CustomEvent('luna-tutorial-action', { detail: { action: step.action } })
          );
        }, 250);
      }
    };
  ...
  const goPrev = () => {
    if (guideStep > 0) setGuideStep((g) => g - 1);
  };
...
function GuideMode({
  ...
  return (
    <>
      ...
      {!isFullScreen && <div style={{ position: 'fixed', inset: 0, zIndex: 999 }} />}
          ...
          >
            <button
              ...
              style={{
                ...
                fontSize: 13,
                cursor: guideStep > 1 ? 'pointer' : 'default',
                fontFamily: "'DM Sans', sans-serif",
              }}
            >
              ‹ Prev
  ...
  if (!started) {
    return (
      ...
      >
            ...
            <div key={p.key} style={{ opacity: 0.4 + i * 0.075 }}>
              {p.isNew ? (
                ...
                <MoonFace
                  size={20}
                  phase={p.age / 29.53}
                  illumination={parseFloat(p.illumination) || 50}
                />
              )}
            </div>
          ))}
        ...
        >
          The lunar cycle is not a clock — it is a living rhythm. Each phase has its own quality,
          invitation, and way of moving. Understanding them changes how you work with time.
        </div>
      ...
      >
        <button
          ...
          style={{
            ...
            fontSize: 14,
            cursor: phaseIdx > 0 ? 'pointer' : 'default',
          }}
        >
          ‹ Prev
        </button>
    ...
    <div style={{ paddingTop: 0, animation: 'tutSlideUp 0.35s ease' }}>
      ...
      <div
        style={{
          height: 140,
          background:
            'radial-gradient(ellipse at 50% 0%, rgba(245,230,200,0.07) 0%, transparent 65%)',
          marginLeft: -20,
          marginRight: -20,
          marginBottom: -60,
          pointerEvents: 'none',
  ...
  const illustrations = {
    ...
    'waxing-crescent': (
      ...
      <>
        ...
        {/* left cotyledon */}
        <path
          d="M71 54 Q56 44 50 52 Q56 62 71 58 Z"
          fill={s(0.16)}
          stroke={s(0.5)}
          strokeWidth="0.9"
        />
        {/* right cotyledon */}
        <path
          d="M71 54 Q86 44 92 52 Q86 62 71 58 Z"
          fill={s(0.16)}
          stroke={s(0.5)}
          strokeWidth="0.9"
        />
    ...
    'first-quarter': (
      ...
      <>
        ...
        {/* leaf low-left */}
        <path
          d="M69 70 Q50 60 44 66 Q52 74 69 72 Z"
          fill={s(0.16)}
          stroke={s(0.45)}
          strokeWidth="0.9"
        />
        {/* leaf low-right */}
        <path
          d="M70 62 Q90 52 94 59 Q87 67 70 65 Z"
          fill={s(0.16)}
          stroke={s(0.45)}
          strokeWidth="0.9"
        />
        {/* leaf mid-left */}
        <path
          d="M69 50 Q54 40 50 47 Q56 55 69 53 Z"
          fill={s(0.13)}
          stroke={s(0.4)}
          strokeWidth="0.9"
        />
        {/* top bud */}
        <path
          d="M70 30 Q66 22 70 16 Q74 22 70 30"
          fill={s(0.22)}
          stroke={s(0.55)}
          strokeWidth="0.9"
        />
    ...
    'waxing-gibbous': (
      ...
      <>
        ...
        {/* lower-left leaf */}
        <path
          d="M69 66 Q44 55 38 62 Q48 72 69 69 Z"
          fill={s(0.17)}
          stroke={s(0.42)}
          strokeWidth="0.9"
        />
        {/* lower-right leaf */}
        <path
          d="M70 58 Q95 47 99 55 Q90 63 70 62 Z"
          fill={s(0.17)}
          stroke={s(0.42)}
          strokeWidth="0.9"
        />
        {/* mid-left leaf */}
        <path
          d="M69 50 Q52 42 48 48 Q55 56 69 53 Z"
          fill={s(0.14)}
          stroke={s(0.38)}
          strokeWidth="0.9"
        />
    ...
    full: (
      ...
      <>
        ...
        {/* leaves */}
        <path
          d="M69 68 Q44 57 38 65 Q50 75 69 72 Z"
          fill={s(0.18)}
          stroke={s(0.45)}
          strokeWidth="0.9"
        />
        <path
          d="M70 56 Q96 45 100 54 Q89 63 70 60 Z"
          fill={s(0.18)}
          stroke={s(0.45)}
          strokeWidth="0.9"
        />
    ...
    'waning-gibbous': (
      ...
      <>
        ...
        <path
          d="M69 68 Q46 57 40 64 Q50 73 69 71 Z"
          fill={s(0.17)}
          stroke={s(0.4)}
          strokeWidth="0.9"
        />
        <path
          d="M70 55 Q95 44 99 52 Q88 61 70 58 Z"
          fill={s(0.15)}
          stroke={s(0.38)}
          strokeWidth="0.9"
        />
        <path
          d="M69 44 Q55 36 51 42 Q57 50 69 47 Z"
          fill={s(0.12)}
          stroke={s(0.32)}
          strokeWidth="0.9"
        />
        ...
        {/* falling leaf 1 */}
        <path
          d="M52 66 Q44 72 46 79 Q53 76 55 70 Z"
          fill={s(0.14)}
          stroke={s(0.28)}
          strokeWidth="0.8"
        ...
        {/* falling leaf 2 */}
        <path
          d="M90 72 Q98 67 96 60 Q89 62 90 70 Z"
          fill={s(0.12)}
          stroke={s(0.24)}
          strokeWidth="0.8"
    ...
    'last-quarter': (
      ...
      <>
        ...
        {/* one last leaf */}
        <path
          d="M69 55 Q53 46 50 52 Q56 60 69 58 Z"
          fill={s(0.13)}
          stroke={s(0.35)}
          strokeWidth="0.9"
        />
        ...
        {/* leaves on ground */}
        <path
          d="M42 86 Q36 83 33 88 Q39 90 43 87 Z"
          fill={s(0.1)}
          stroke={s(0.2)}
          strokeWidth="0.8"
        />
        <path
          d="M95 86 Q101 82 105 87 Q99 90 96 87 Z"
          fill={s(0.1)}
          stroke={s(0.2)}
          strokeWidth="0.8"
        />
        <path
          d="M62 86 Q57 83 54 87 Q59 90 63 87 Z"
          fill={s(0.08)}
          stroke={s(0.16)}
          strokeWidth="0.8"
        />
    ...
    'waning-crescent': (
      ...
      <>
        ...
        {/* trunk */}
        <path
          d="M70 90 Q68 74 70 55 Q71 40 70 18"
          stroke={s(0.48)}
          strokeWidth="2.5"
          fill="none"
          strokeLinecap="round"
...
function PhaseCard({ phase, moonAge }) {
  ...
  return (
    <div style={{ paddingTop: 0, animation: 'tutSlideUp 0.35s ease' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 8, paddingTop: 20 }}>
        <MoonFace size={80} phase={moonAge} illumination={parseFloat(phase.illumination) || 50} />
      </div>
