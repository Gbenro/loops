  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            style={{ width: 36, height: 4, borderRadius: 2, background: 'var(--color-border-mid)' }}
          />
        </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <span style={{ marginLeft: 'auto' }}>
                          {u.last_seen
                            ? new Date(u.last_seen).toLocaleDateString('en-US', {
                                month: 'short',
                                day: 'numeric',
                              })
                            : 'never'}
              ...
              {activeTab === 'allowlist' && (
                <div>
                  ...
                  >
                    ...
                    {addError && (
                      <div
                        style={{ fontSize: 11, color: 'rgba(252,129,129,0.8)', marginBottom: 8 }}
                      >
                        {addError}
                      </div>
                    )}
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    {allowlist.map((entry) => (
                      ...
                      >
                        <div style={{ flex: 1 }}>
                          <div
                            style={{ fontSize: 13, color: 'var(--color-text)', marginBottom: 2 }}
                          >
                            {entry.email}
                          </div>
                          {entry.note && (
