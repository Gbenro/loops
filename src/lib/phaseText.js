...
const TEXT_SLOTS = {
  ...
  noLoopsMessage: {
    ...
    phases: {
      new: [
        'No loops yet. The dark is full of potential.',
        'Empty — like the new moon. What wants to form?',
      ],
      'waxing-crescent': [
        'No loops yet. The crescent has energy for beginning.',
        'Start something. The waxing supports it.',
      ],
      'first-quarter': [
        'No loops yet. What are you willing to commit to?',
        'Empty at the threshold. A decision could change that.',
      ],
      'waxing-gibbous': [
        'No loops yet. What are you building toward the peak?',
        'The gibbous is for finishing. What do you have to finish?',
      ],
      full: [
        'No loops at full moon. What does the light illuminate without you doing anything?',
        'Empty at the peak. Witness what is present without creating.',
      ],
      'waning-gibbous': [
        'No loops in the giving phase. What do you have to share?',
        'Empty — that can be a gift too.',
      ],
      'last-quarter': [
        'No loops to close. Perhaps the clearing is complete.',
        'Empty at last quarter. Sometimes that is the release.',
      ],
      'waning-crescent': [
        'No loops. Good. The waning crescent asks for rest, not action.',
        'Empty before the dark. Let it be.',
      ],
    },
  },
  ...
  noLoopsSubtext: {
    ...
    phases: {
      ...
      'waxing-crescent': [
        'Start with momentum. The crescent is building.',
        'Create a phase loop to ride the waxing energy.',
      ],
      'first-quarter': [
        'The threshold demands commitment. What will you choose?',
        'Phase loops close with the moon. Choose wisely.',
      ],
      'waxing-gibbous': [
        'The peak approaches. What work needs finishing?',
        'A phase loop now means completing by full moon.',
      ],
      full: [
        'The light reveals. Perhaps rest is the action.',
        'Witnessing is also a loop. What do you see?',
      ],
      'waning-gibbous': [
        'The waning shares. What have you learned?',
        'Open loops can close. Phase loops can release.',
      ],
      'last-quarter': [
        'Release takes no tracking. But you could name what goes.',
        'A phase loop now means letting go.',
      ],
      'waning-crescent': [
        'Rest asks for stillness. Creating can wait.',
        'The new moon is coming. Prepare in quiet.',
      ],
    },
  },
  ...
  noEchoesMessage: {
    ...
    phases: {
      new: [
        'No echoes yet. The silence is full.',
        'Nothing recorded. What is forming in the dark?',
      ],
      'waxing-crescent': [
        'No echoes yet. What is beginning to stir?',
        'Empty journal. The crescent invites first words.',
      ],
      'first-quarter': [
        'No echoes yet. What decision is pressing?',
        'The threshold has questions. What are yours?',
      ],
      'waxing-gibbous': [
        'No echoes yet. What are you noticing as the peak approaches?',
        'Almost at full moon. What do you see?',
      ],
      full: [
        'No echoes at full moon. The light reveals without words too.',
        'Nothing recorded at the peak. That is also a witness.',
      ],
      'waning-gibbous': [
        'No echoes yet. What wants to be expressed?',
        'The sharing phase is open. What do you have to say?',
      ],
      'last-quarter': [
        'No echoes at last quarter. The silence can be release.',
        'Nothing to say. That is valid at the clearing.',
      ],
      'waning-crescent': [
        'No echoes. Rest does not require recording.',
        'Silence before the dark. Let it be quiet.',
      ],
    },
  },
  ...
  noRhythmsMessage: {
    ...
    phases: {
      new: [
        'No rhythms yet. The new moon is a good time to name what you want to track.',
        'No practices being observed. What wants your attention this cycle?',
      ],
      'waxing-crescent': [
        'No rhythms yet. What practice is building?',
        'Name something you are doing. Watch how it moves.',
      ],
      'first-quarter': [
        'No rhythms yet. What practice needs commitment?',
        'The quarter asks: what are you actually doing?',
      ],
      'waxing-gibbous': [
        'No rhythms yet. What practice carries you to the peak?',
        'Name what you are already doing. Observe it.',
      ],
      full: [
        'No rhythms tracked. At full moon, see what practices you actually have.',
        'What do you do without tracking it? That is the rhythm.',
      ],
      'waning-gibbous': [
        'No rhythms yet. What practice could you share?',
        'The giving phase. What are you already practicing?',
      ],
      'last-quarter': [
        'No rhythms. Perhaps the practice is releasing.',
        'No practices to observe. Let that be the observation.',
      ],
      'waning-crescent': [
        'No rhythms. Rest is also a rhythm.',
        'No practices tracked. The waning asks for stillness.',
      ],
    },
  },
  ...
  noRhythmsSubtext: {
    ...
    phases: {
      new: [
        'Name what you do. Watch it through the cycle.',
        'The dark is for naming. What practice will you observe?',
      ],
      'waxing-crescent': [
        'Start observing. The crescent momentum will carry it.',
        'Not a task — a witness. What are you already doing?',
      ],
      'first-quarter': [
        'Commit to observing. Not doing more — just watching.',
        'The practice exists or it does not. Name it.',
      ],
      'waxing-gibbous': [
        'Almost at the peak. What practice are you bringing there?',
        'Observation reveals rhythm. What do you repeat?',
      ],
      full: [
        'Witnessing, not tracking. What do you see yourself doing?',
        'The full moon illuminates patterns. What is yours?',
      ],
      'waning-gibbous': [
        'What practice wants sharing? Name it, observe it.',
        'Teaching is a rhythm. What do you pass on?',
      ],
      'last-quarter': [
        'Release can be a practice. Name what you let go of.',
        'Clearing as rhythm. What do you repeatedly release?',
      ],
      'waning-crescent': [
        'Rest is a practice. Sleep is a rhythm.',
        'Stillness observed is still a rhythm.',
      ],
    },
  },
